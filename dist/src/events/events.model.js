...
__decorate([
    swagger_1.ApiProperty({ example: 'ТВОЕ МЕСТО У МАСЛЁНКИ', description: 'title events' }),
...
__decorate([
    swagger_1.ApiProperty({ example: 'выставка РАБОТ АНДРЕЯ САМОЗВАННОГО', description: 'subtitle events' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Events.prototype, "subtitle", void 0);
__decorate([
    swagger_1.ApiProperty({ example: '22 — 34 СЕНТЯБРЯ 2021', description: 'date events' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Events.prototype, "dateEvent", void 0);
__decorate([
    swagger_1.ApiProperty({ example: '15_AkemiTakeya_LemonismXActionism_mumok_33(c)KarolinaMiernik 3', description: 'mainImage events' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
], Events.prototype, "mainImage", void 0);
__decorate([
    swagger_1.ApiProperty({ example: 'Первые годы биографии Айвазовского прошли в бедности в результате разорения', description: 'second title events' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.TEXT, allowNull: false }),
    __metadata("design:type", String)
...
Events = __decorate([
    sequelize_typescript_1.Table({ tableName: 'art_events' })
], Events);
