...
let AuthService = class AuthService {
    ...
    async registration(userDto) {
        ...
        if (candidate) {
            throw new common_1.HttpException('Пользователь существует', common_1.HttpStatus.BAD_REQUEST);
        }
    ...
    async validateUser(userDto) {
        ...
        throw new common_1.UnauthorizedException({ message: 'password or login uncorrect' });
    }
};
